...
namespace TraderData.Migrations
{
    ...
    [Migration("20171119121950_ChangeEnquiries")]
    partial class ChangeEnquiries
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TraderData.Models.InstrumentModels.InstrumentPrice", b =>
                {
                    b.Property<int>("InstrumentPriceID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TraderData.Models.ContactModels.Enquiry", b =>
                {
                    b.HasOne("TraderData.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
